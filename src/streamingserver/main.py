                ...
                for idx, segment in enumerate(playlist.segments):
                    ...
                    if different_uris(previous_uri, segment.uri):
                        ...
                        if previous_resolution != current_resolution:
                            ...
                            write_log(section_file, segment.uri, section_index, segment_index, msg="resolution-change")
                            new_section = True
                        ...
                        if current_filler != previous_filler:
                            ...
                            write_log(section_file, segment.uri, section_index, segment_index, msg="filler-change")
                    ...
                    if monotonize_segment:
                        ...
                        write_log(section_file, segment.uri, section_index, segment_index, msg="monotonize")
