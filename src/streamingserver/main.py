...
from ts_utils import shift_segment, read_pts_from_segment, is_valid_ts_segment, set_discontinuity_segment, segment_starts_with_keyframe
        ...
        try:
            while not self._stop_event.is_set():
                ...
                for current_uri, segment_encryption_info, current_duration in uri_list:
                    ...
                    if not keyframe:
                        if not segment_starts_with_keyframe(segment_data):
