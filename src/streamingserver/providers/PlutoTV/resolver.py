...
This module contains a simple passthrough resolver for PlutoTV that returns
...
class Resolver(BaseResolver):
    """PlutoTV passthrough resolver - returns URLs unchanged"""

    def __init__(self):
        super().__init__()
        self.name = "plutotv"
        self.domains = ["pluto.tv", "plutotv.com"]

    def can_resolve(self, _url: str) -> bool:
        """Check if this resolver can handle the URL"""
        # Accept any URL for PlutoTV (passthrough behavior)
        return True
